                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr v-for="subscription in Subscriptions" :key="subscription.key">
                                ...
                                <td>
                                    <router-link :to="{name: 'edit', params: { id: subscription.key }}" class="btn btn-primary btn- sm px-3"> Edit </router-link>
                                    <button @click.prevent="deleteSubscription(subscription.key)" class="btn btn-danger btn- sm px-3"> Delete </button>
